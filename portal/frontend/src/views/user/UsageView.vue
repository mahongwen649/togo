<template>
  <AppLayout>
    <div :class="isMobileH5 ? 'space-y-4' : 'space-y-6'">
      ...
      <div class="card" :class="isMobileH5 ? 'p-3' : 'p-6'">
        <button
          v-if="isMobileH5"
          type="button"
          class="flex w-full items-center justify-between gap-3 text-left"
          :aria-expanded="filterContentVisible"
          @click="toggleFilters"
        >
          ...
          <Icon :name="filterContentVisible ? 'chevronUp' : 'chevronDown'" size="sm" class="text-gray-400" />
        </button>
        <div v-show="filterContentVisible" :class="isMobileH5 ? 'mt-3 block' : 'flex flex-wrap items-end justify-between gap-4'">
          <div v-if="activeTab === 'errors'" :class="isMobileH5 ? 'grid w-full grid-cols-2 gap-2' : 'flex flex-1 flex-wrap items-end gap-4'">
            ...
            <div :class="isMobileH5 ? 'min-w-0' : 'w-full sm:w-auto sm:min-w-[180px]'">
          ...
          <div v-else :class="isMobileH5 ? 'grid w-full grid-cols-2 gap-2' : 'flex flex-1 flex-wrap items-end gap-4'">
            <div :class="isMobileH5 ? 'min-w-0' : 'w-full sm:w-auto sm:min-w-[220px]'">
          ...
          <div :class="['flex flex-wrap items-center justify-end gap-3', isMobileH5 ? 'mt-3 w-full' : 'w-full sm:w-auto']">
...
const { t } = useI18n()
const {
  contentVisible: filterContentVisible,
  isMobileH5,
  toggleMobile: toggleFilters,
} = useMobileCollapse()
