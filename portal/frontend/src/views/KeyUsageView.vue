              ...
              <table class="w-full">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td class="px-4 py-3 text-sm tabular-nums text-right font-medium text-green-600 dark:text-green-400">{{ usd(row.actual_cost != null ? row.actual_cost : row.cost) }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table class="w-full">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td class="px-4 py-3 text-sm tabular-nums text-right font-medium text-green-600 dark:text-green-400">{{ usd(m.actual_cost != null ? m.actual_cost : m.cost) }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
...
function getDateParams(): string {
  const now = new Date()
  const fmt = (d: Date) => formatDateLocalInput(d)
...
function cancelRingAnimation() {
  ...
  if (ringStartFrame !== null && typeof cancelAnimationFrame === 'function') {
