...
Potential improvements within the current Portal scope:

- Password strength meter
- Email verification flow refinements
- Forgot password flow refinements
- CAPTCHA / Turnstile UX improvements
