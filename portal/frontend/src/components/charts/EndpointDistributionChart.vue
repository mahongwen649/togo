  ...
  <div class="card" :class="isMobileH5 ? 'p-3' : 'p-4'">
    ...
    >
      ...
      >
        ...
        <Icon name="chevronDown" size="sm" class="ml-2 shrink-0 text-gray-400 transition-transform" :class="contentVisible ? 'rotate-180' : ''" />
      </button>
      <h3 v-else class="text-sm font-semibold text-gray-900 dark:text-white">
        {{ title || t('usage.endpointDistribution') }}
      </h3>
      <div v-show="contentVisible" class="flex flex-wrap items-center justify-end gap-2">
        <div
