...
const handleSave = async () => {
  ...
  try {
    ...
    if (editingAttribute.value) {
      await userAttributesAPI.updateDefinition(editingAttribute.value.id, data)
      appStore.showSuccess(t('admin.users.attributes.updated'))
    } else {
      await userAttributesAPI.createDefinition(data)
...
const handleDelete = async () => {
  ...
  try {
    await userAttributesAPI.deleteDefinition(deletingAttribute.value.id)
