  ...
  <div class="card">
    ...
    <div class="space-y-3 p-4">
      ...
      <button v-if="canUseBatchImage" @click="router.push('/batch-image')" class="group flex w-full items-center gap-4 rounded-xl bg-gray-50 p-4 text-left transition-all duration-200 hover:bg-gray-100 dark:bg-dark-800/50 dark:hover:bg-dark-800">
        <div class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-teal-100 transition-transform group-hover:scale-105 dark:bg-teal-900/30">
          <Icon name="sparkles" size="lg" class="text-teal-600 dark:text-teal-400" />
        </div>
        <div class="min-w-0 flex-1">
        ...
        <Icon
          name="chevronRight"
          size="md"
          class="text-gray-400 transition-colors group-hover:text-teal-500 dark:text-dark-500"
        />
      </button>
