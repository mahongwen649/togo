      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-bold text-gray-900 dark:text-white">
            <span class="text-green-600 dark:text-green-400" :title="t('dashboard.actual')">¥{{ formatCost(stats?.today_actual_cost || 0) }}</span>
          ...
          <p class="text-xs">
            ...
            <span class="text-green-600 dark:text-green-400" :title="t('dashboard.actual')">¥{{ formatCost(stats?.total_actual_cost || 0) }}</span>
      ...
      >
        ...
        <div class="mt-2 space-y-1 text-xs">
          <div class="flex items-center justify-between">
            ...
            <span class="font-mono text-green-600 dark:text-green-400">¥{{ formatCost(item.today_actual_cost) }}</span>
          </div>
          <div class="flex items-center justify-between">
