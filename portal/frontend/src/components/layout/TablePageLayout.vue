<template>
  <div class="table-page-layout" :class="{ 'mobile-mode': isMobileH5 }">
    <!-- 固定区域：操作按钮 -->
...
.table-page-layout.mobile-mode .layout-section-filters :deep(.h5-filter-grid) {
...
.table-page-layout.mobile-mode .layout-section-filters :deep(.h5-filter-actions) {
  width: 100% !important;
  grid-column: 1 / -1;
