...
const PREFETCH_ADJACENCY: Record<string, string[]> = {
  ...
  '/admin/users': ['/admin/companies', '/admin/dashboard'],
  '/admin/companies': ['/admin/users', '/admin/finance'],
  '/admin/finance': ['/admin/dashboard', '/admin/usage'],
  '/admin/usage': ['/admin/dashboard', '/admin/users'],
  // User routes
