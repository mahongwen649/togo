export default {
  ...
  profile: {
    ...
    securityDescription: 'Password and notification settings live in the right rail.',
    ...
    balanceNotify: {
      ...
      description: 'Automatically email the account address when balance falls below the system threshold',
