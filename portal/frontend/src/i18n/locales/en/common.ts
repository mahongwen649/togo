export default {
  ...
  openaiWsMode: {
    ...
    passthroughHint: 'Passthrough mode does not use the WS connection pool.'
  },
  ...
  nav: {
	...
	imageGeneration: 'Image Test',
	imageGenerationOpenFailed: 'Failed to open image test. Please try again later.',
    usage: 'Usage',
    recharge: 'Recharge',
    giftCampaign: 'Code Giveaway',
    paymentOrders: 'Recharge history',
    redeem: 'Redeem',
  ...
  auth: {
    ...
    errors: {
      EMAIL_VERIFY_REQUIRED: 'Please verify your email before registering.',
      VERIFY_CODE_REQUIRED: 'Please enter the email verification code.',
      INVALID_VERIFY_CODE: 'The verification code is invalid or expired. Please request a new code.',
      VERIFY_CODE_INVALID: 'The verification code is invalid or expired. Please request a new code.',
      EMAIL_ALREADY_REGISTERED: 'This email is already registered. Please sign in instead.',
      USERNAME_ALREADY_EXISTS: 'This username is already in use. Please choose another one.',
    ...
    registrationCodeLabel: 'Registration Invitation Code',
    registrationCodePlaceholder: 'Enter registration invitation code',
    affiliateCodeLabel: 'Affiliate Code',
    affiliateCodePlaceholder: "Enter the inviter's affiliate code (optional)",
    ...
    forgotPasswordHint: 'Enter your email address and we will send you a password reset code.',
    sendResetLink: 'Send Reset Link',
    sendingResetLink: 'Sending...',
    sendResetLinkFailed: 'Failed to send reset link. Please try again.',
    passwordResetCodeSentHint: 'A verification code was sent to your email. Enter it and set a new password.',
    passwordResetResendCodeCountdown: 'Resend code in {countdown}s',
    passwordResetResendCode: 'Resend code',
    sendingVerificationCode: 'Sending code...',
    sendVerificationCode: 'Send code',
    invalidVerificationCode: 'Enter a valid 6-digit code',
    passwordResetCodeSent: 'Verification code sent',
    sendVerificationCodeFailed: 'Failed to send verification code. Please try again.',
    passwordResetUsesCode: 'Password reset now uses an email verification code. Request a code to continue.',
    ...
    layout: {
      logoAlt: 'Site logo',
      brandDirection: 'AI service gateway',
      gatewayEyebrow: 'Unified access · Precise billing · Team management',
      heroTitle: 'One place to manage your AI API usage',
      defaultSubtitle: 'A stable, observable API key management portal for teams and individuals',
      relayTitle: 'Unified relay',
      relayDescription: 'Connect to Core services through one Portal entry point.',
      quotaTitle: 'Visible quotas',
      quotaDescription: 'Review balance, subscriptions, usage, and request records clearly.',
      billingTitle: 'Team operations',
      billingDescription: 'Manage users, companies, and finance from operational views.',
      copyright: '© {year} {siteName}. All rights reserved.'
    },
    homePanel: {
      settingsLoadFailed: 'Registration settings could not be loaded. Refresh the page and try again.',
      loggedIn: 'Signed in',
      dashboard: 'Go to dashboard',
      registerTab: 'No account, register',
      loginTab: 'Have an account, log in',
      registrationClosed: 'Registration is closed. Contact an administrator.',
      username: 'Username',
      usernamePlaceholder: 'Enter username',
      email: 'Email',
      password: 'Password',
      ...
      login: 'Log in',
      registerHint: 'After registration you will be signed in automatically.',
      loginHint: 'Log in with email/username and password.',
      readyTitle: 'You are ready',
      startTitle: 'Start using TogoAPI',
      loginTitle: 'Log in to your account',
      processing: 'Processing...',
      verifyAndCreate: 'Verify and create',
      sendCode: 'Send code',
      createAccount: 'Create account',
      suffixMore: 'and {count} more',
      suffixOnly: 'Only {suffixes} emails are allowed',
