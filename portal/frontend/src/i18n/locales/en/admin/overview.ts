export default {
    ...
    users: {
      ...
      groupManagerRole: 'Group manager',
    ...
    companies: {
      title: 'Companies',
      description: 'Manage company profiles, managers, members, and allocations',
      masterData: 'Company Profile',
      ...
      user: 'User',
      noManagers: 'No company managers',
      ...
      noMembers: 'No company members',
      allocate: 'Allocate',
      removeMember: 'Remove Member',
      saveCompany: 'Save Company',
      candidate: 'Select user',
      managerCandidatePlaceholder: 'Search managers to add',
      noCandidates: 'No users available',
      selectedCandidate: 'Selected {user} #{id}',
      userId: 'User ID',
      amount: 'Amount',
      notes: 'Notes',
      ...
      deactivateSuccess: 'Company deactivated',
      deactivateFailed: 'Failed to deactivate company',
      candidatesLoadFailed: 'Failed to load candidate users',
      addMemberSuccess: 'Member added to company',
      removeMemberSuccess: 'Member removed from company',
      memberMutationFailed: 'Failed to update member assignment',
      addManagerSuccess: 'Manager added',
      managerMutationFailed: 'Failed to update manager',
      removeManagerSuccess: 'Manager removed',
      allocateSuccess: 'Allocation successful',
      allocateFailed: 'Allocation failed'
    },
    ...
    groups: {
      ...
      usageToday: 'Today',
      usageTotal: 'Total',
      rateAndResources: '{rate}x rate · {count} resources',
      rateLabel: 'rate',
      form: {
        name: 'Name',
      ...
      modelsList: {
        ...
        hint: 'Only changes the /v1/models response. It does not change which models can be called.',
