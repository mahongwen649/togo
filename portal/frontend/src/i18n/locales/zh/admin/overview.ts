export default {
    ...
    companies: {
      ...
      saveCompany: '保存公司',
      candidate: '选择用户',
      managerCandidatePlaceholder: '搜索可添加经理',
      noCandidates: '暂无可添加用户',
      selectedCandidate: '已选择 {user} #{id}',
      userId: '用户 ID',
      amount: '金额',
      notes: '备注',
      failedToLoadCompanies: '加载公司失败',
      failedToLoadMembers: '加载成员失败',
      failedToLoadManagers: '加载经理失败',
      updateSuccess: '公司已更新',
      createSuccess: '公司已创建',
      saveFailed: '保存公司失败',
      deactivateSuccess: '公司已停用',
      deactivateFailed: '停用公司失败',
      candidatesLoadFailed: '加载候选用户失败',
      addMemberSuccess: '成员已加入公司',
      removeMemberSuccess: '成员已移出公司',
      memberMutationFailed: '成员归属更新失败',
      addManagerSuccess: '经理已添加',
      managerMutationFailed: '经理更新失败',
      removeManagerSuccess: '经理已移除',
    ...
    groups: {
      ...
      nonExclusive: '公开',
      public: '公开',
      rateAndResources: '{rate}x 费率 · {count} 个资源',
      rateLabel: '倍率',
      ...
      subscription: {
        ...
        subscription: '订阅（配额）',
        dailyLimit: '每日限额（人民币）',
        weeklyLimit: '每周限额（人民币）',
        monthlyLimit: '每月限额（人民币）',
      ...
      modelsList: {
        ...
        hint: '仅影响 /v1/models 展示结果，不改变模型实际调用权限。',
        loading: '正在加载模型列表...',
        empty: '暂无可展示模型',
