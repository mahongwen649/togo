export default {
  ...
  openaiWsMode: {
    concurrencyHint: '启用 WS mode 后，该账号并发数将作为该账号 WS 连接池上限。',
    passthroughHint: 'passthrough 模式不使用 WS 连接池。'
  },
  ...
  nav: {
    ...
    apiKeys: 'API 密钥',
	batchImage: '批量生图',
	imageGeneration: '生图测试',
	imageGenerationOpenFailed: '打开生图测试失败，请稍后重试',
    usage: '使用记录',
    recharge: '余额充值',
    giftCampaign: '兑换活动',
    paymentOrders: '充值记录',
  ...
  auth: {
    ...
    signIn: '登录',
    signingIn: '登录中...',
    loginIdentifierLabel: '邮箱或用户名',
    loginIdentifierPlaceholder: '请输入邮箱或用户名',
    loginIdentifierRequired: '请输入邮箱或用户名',
    createAccount: '创建账户',
    ...
    usernameHint: '3-32 位，仅支持字母、数字、下划线和短横线',
    ...
    errors: {
      ...
      INVALID_VERIFY_CODE: '验证码无效或已过期，请重新获取',
      VERIFY_CODE_INVALID: '验证码无效或已过期，请重新获取',
      EMAIL_ALREADY_REGISTERED: '该邮箱已注册，请直接登录',
      USERNAME_ALREADY_EXISTS: '该用户名已被使用，请换一个',
    ...
    registrationCodeLabel: '注册邀请码',
    registrationCodePlaceholder: '请输入注册邀请码',
    affiliateCodeLabel: '邀请返利码',
    affiliateCodePlaceholder: '请输入邀请人的返利码（可选）',
    ...
    forgotPasswordHint: '输入您的邮箱地址，我们将向您发送密码重置验证码。',
    sendResetLink: '发送重置链接',
    sendingResetLink: '发送中...',
    sendResetLinkFailed: '发送重置链接失败，请重试。',
    passwordResetCodeSentHint: '验证码已发送到您的邮箱，请输入验证码并设置新密码。',
    passwordResetResendCodeCountdown: '{countdown}秒后可重新发送',
    passwordResetResendCode: '重新发送验证码',
    sendingVerificationCode: '发送验证码中...',
    sendVerificationCode: '发送验证码',
    invalidVerificationCode: '请输入有效的6位验证码',
    passwordResetCodeSent: '验证码已发送',
    sendVerificationCodeFailed: '发送验证码失败，请重试。',
    passwordResetUsesCode: '密码重置已改用邮箱验证码，请返回并获取验证码。',
    ...
    layout: {
      logoAlt: '站点 Logo',
      brandDirection: 'AI 服务网关',
      gatewayEyebrow: '统一接入 · 精准计费 · 团队管理',
      heroTitle: '一个入口，管理你的 AI API 使用',
      defaultSubtitle: '为团队和个人提供稳定、可观测的 API Key 管理入口',
      relayTitle: '统一转发',
      relayDescription: '用一个 Portal 入口连接后端 Core 服务。',
      quotaTitle: '额度可见',
      quotaDescription: '清晰查看余额、订阅、用量和请求记录。',
      billingTitle: '团队管理',
      billingDescription: '支持用户、公司与财务视角的运营管理。',
      copyright: '© {year} {siteName}. All rights reserved.'
    },
    homePanel: {
      settingsLoadFailed: '注册配置加载失败，请刷新页面后重试。',
      loggedIn: '已登录',
      dashboard: '进入控制台',
      registerTab: '没有账号，注册',
      loginTab: '已有账号，登录',
      registrationClosed: '注册暂未开放，请联系管理员。',
      username: '用户名',
      usernamePlaceholder: '请输入用户名',
      email: '邮箱',
      password: '密码',
      ...
      inputPassword: '请输入密码',
      login: '登录',
      registerHint: '注册后将自动登录并进入控制台。',
      loginHint: '使用邮箱/用户名和密码登录。',
      readyTitle: '你已准备就绪',
      startTitle: '开始使用 TogoAPI',
      loginTitle: '登录你的账号',
      processing: '处理中...',
      verifyAndCreate: '验证并创建',
      sendCode: '发送验证码',
      createAccount: '创建账号',
      suffixMore: '等 {count} 项',
      suffixOnly: '仅允许 {suffixes} 邮箱注册',
      enterAccount: '请输入账号',
