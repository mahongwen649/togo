export default {
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 Sub2API',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Sub2API Portal 用于管理用户、公司、公告、使用记录、财务统计和 API 密钥。</p><p style="margin-bottom: 12px;"><b>🎯 当前 Portal 职责：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>👥 <b>用户与公司</b> - 管理访问权限和组织关系</li><li>📣 <b>公告</b> - 向用户发布站点消息</li><li>📊 <b>统计</b> - 查看使用记录和财务汇总</li><li>🔑 <b>密钥</b> - 为用户生成独立 API Key</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们从创建 API 密钥开始 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
        title: '🔑 生成密钥',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">API Key 是用户调用服务的凭证。</p><div style="padding: 8px 12px; background: #eff6ff; border-left: 3px solid #3b82f6; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>🔑 API Key 的作用：</b><ul style="margin: 8px 0 0 16px;"><li>用于调用 AI 服务</li><li>可以设置配额和有效期</li><li>支持独立的使用统计</li></ul></div><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"API 密钥"</p></div>'
      },
      createKey: {
        title: '➕ 创建密钥',
        description:
      ...
      keyGroup: {
        title: '🎯 2. 选择分组',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">选择这个密钥所属的分组。</p><div style="padding: 8px 12px; background: #eff6ff; border-left: 3px solid #3b82f6; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>📌 分组决定：</b><ul style="margin: 8px 0 0 16px;"><li>密钥适用的服务范围</li><li>计费倍率和额度策略</li><li>是否为专属访问</li></ul></div><p style="padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 提示：</b>如果列表为空，请先确认 Core 已同步可用分组。</p></div>',
        nextBtn: '下一步'
      },
      keySubmit: {
        title: '🎉 生成并复制',
  ...
  payment: {
    portal: {
      recharge: '余额充值', ordersTitle: '充值记录', statusTitle: '支付结果', description: '使用支付宝为账户充值人民币余额',
      amount: '充值金额', customAmount: '自定义金额', receive: '到账余额', rate: '充值比例', fee: '手续费',
      bonusBadge: '赠 ¥{amount}', hot: '热', campaignAmountLabel: '充值 ¥{amount}，{hot}赠送 ¥{bonus}',
      alipay: '支付宝', payNow: '立即支付', processing: '正在创建订单...', disabled: '充值功能暂未开放',
      unavailable: '支付宝当前不可用', invalidAmount: '请输入有效的充值金额', range: '单笔限额 ¥{min} - ¥{max}',
      opened: '支付页面已打开，请完成付款', popupBlocked: '浏览器拦截了支付窗口，请允许弹窗后重试',
      createFailed: '创建支付订单失败', viewOrders: '查看充值记录', checking: '正在确认支付结果...',
      success: '充值成功', successDesc: '余额已经到账，可返回控制台继续使用。', pending: '等待支付确认',
      pendingDesc: '支付结果尚未确认，页面会自动刷新。', failed: '支付未完成',
      failedDesc: '订单已失败、取消或过期，请重新发起充值。', backRecharge: '返回充值', backDashboard: '返回控制台',
      orderNo: '订单号', paidAmount: '支付金额', creditedAmount: '到账金额', createdAt: '创建时间',
      orderStatus: '状态', action: '操作', empty: '暂无充值记录', cancel: '取消订单', refresh: '刷新',
      campaignBonusRow: '充值赠送额度', campaignBonusStatuses: { PENDING: '待到账', APPLYING: '到账中', APPLIED: '已到账', FAILED: '到账失败' },
      loadFailed: '加载支付信息失败',
      invoiceApply: '申请发票', invoiceDialogTitle: '申请发票', invoiceRequirementTitle: '开票说明',
      invoiceRequirement: '充值金额满 ¥100 后可申请开具发票。', invoiceWechatLabel: '微信客服',
      invoiceContactHint: '添加客服微信后，请提供充值账号、订单号和开票信息，客服会协助处理。',
      copyWechat: '复制微信号', wechatCopied: '微信号已复制', invoiceClose: '我知道了',
      refundApply: '申请退款', refundDialogTitle: '申请退款', refundRequirementTitle: '退款说明',
      refundRequirement: '如需申请退款，请联系微信客服提交申请。',
      refundContactHint: '添加客服微信后，请提供充值账号、订单号和退款原因，客服会协助处理。',
      statuses: { PENDING: '待支付', PAID: '已支付', RECHARGING: '到账中', COMPLETED: '已完成', EXPIRED: '已过期', CANCELLED: '已取消', FAILED: '失败', REFUND_REQUESTED: '退款申请中', REFUNDING: '退款中', REFUND_PENDING: '退款待确认', PARTIALLY_REFUNDED: '部分退款', REFUNDED: '已退款', REFUND_FAILED: '退款失败' }
    },
    title: '充值/订阅',
    amountLabel: '充值金额',
    paymentAmount: '支付金额',
    ...
    rechargeRatePreview: '当前比例：¥1 = ¥{usd} 账户余额',
    refundReason: '退款原因',
